struct SwapIndex{S <: AbstractString, TP <: TenorPeriod, B <: BusinessCalendar, C <: BusinessDayConvention, DC <: DayCount, T <: TermStructure} <: InterestRateIndex
  familyName::S
  tenor::TP
  fixingDays::Int
  currency::Currency
  ...
  SwapIndex{S, TP, B, C, DC, T}(familyName::S,
                                tenor::TP,
                                fixingDays::Int,
                                currency::Currency,
                                fixingCalendar::B,
                                ...
                                discount::T,
                                iborIndex::IborIndex,
                                exogenousDiscount::Bool = true) where {S, TP, B, C, DC, T} =
            new{S, TP, B, C, DC, T}(familyName, tenor, fixingDays, currency, fixingCalendar, fixedLegTenor, fixedLegConvention, fixedLegDayCount, discount,
                                    iborIndex, exogenousDiscount)
end

SwapIndex{S <: AbstractString, TP <: TenorPeriod, B <: BusinessCalendar, C <: BusinessDayConvention, DC <: DayCount, T <: TermStructure}(familyName::S,
                                                                                                                      tenor::TP,
                                                                                                                      settlementDays::Int,
                                                                                                                      currency::Currency,
                                                                                                                      fixingCalendar::B,
