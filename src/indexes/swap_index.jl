immutable SwapIndex{S <: AbstractString, TP <: TenorPeriod, I <: Integer, B <: BusinessCalendar, C <: BusinessDayConvention, DC <: DayCount, T <: TermStructure} <: InterestRateIndex
  ...
  SwapIndex(familyName::S, tenor::TP, settlementDays::I, currency::Currency, fixingCalendar::B, fixedLegTenor::Dates.Period, fixedLegConvention::C, fixedLegDayCount::DC,
            discount::T, iborIndex::IborIndex, exogenousDiscount::Bool = true) =
            new{S, TP, I, B, C, DC, T}(familyName, tenor, settlementDays, currency, fixingCalendar, fixedLegTenor, fixedLegConvention, fixedLegDayCount, discount, iborIndex, exogenousDiscount)
end
...
function EuriborSwapIsdaFixA(tenor::TenorPeriod, discTS::YieldTermStructure, forwardingTS::YieldTermStructure)
